...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} مبروك ياحته🦦 , كسبت  +7000 اكسبي` : isTie ? 'تبا تعادل بس عاش🦦' : `دورك@${room.game.currentTurn.split('@')[0]}`}
`.trim()
